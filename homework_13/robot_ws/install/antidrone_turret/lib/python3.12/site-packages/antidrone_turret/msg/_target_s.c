...
bool antidrone_turret__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("antidrone_turret.msg._target.Target", full_classname_dest, 35) == 0);
  }
  antidrone_turret__msg__Target * ros_message = _ros_message;
  {  // visible
...
PyObject * antidrone_turret__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("antidrone_turret.msg._target");
